...
import {
  ...
  FaCalendarAlt, FaSignOutAlt, FaLayerGroup, FaUserShield
} from 'react-icons/fa';
...
const Sidebar = () => {
  ...
  const isSuperAdmin = user?.emailId === "bhumivyas@admin.com";
      ...
      <ul className="flex flex-col items-start pl-4 pr-3 space-y-2 text-sm font-medium">
        ...
        {isSuperAdmin && (
          <li
            ...
            className="flex items-center gap-3 px-3 py-2 rounded-lg w-full cursor-pointer transition duration-200 hover:bg-blue-500"
          >
